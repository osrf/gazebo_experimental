...
class gazebo::server::EntityQueryRegistrarPrivate
{
...
/////////////////////////////////////////////////
void EntityQueryRegistrar::Register(EntityQuery &&_q, QueryCallback _cb)
{
  this->dataPtr->queryCallbacks.emplace_back(
      std::make_pair(std::move(_q), _cb));
}

/////////////////////////////////////////////////
std::vector<QueryRegistration> &EntityQueryRegistrar::Registrations() const
{
