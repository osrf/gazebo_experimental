...
#ifndef GAZEBO_COMPONENTIZERS_CZPHYSICSCONFIG_HH__
#define GAZEBO_COMPONENTIZERS_CZPHYSICSCONFIG_HH__
...
namespace gazebo
{
  ...
  {
    /// \brief a plugin creates "PhysicsConfig" component where appropriate
