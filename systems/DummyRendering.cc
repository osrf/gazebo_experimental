...
#include "gazebo/systems/DummyRendering.hh"

using namespace gazebo;
using namespace systems;

/////////////////////////////////////////////////
ecs::EntityQuery DummyRendering::Init()
{
  ...
  // TODO how to get camera information?
...
/////////////////////////////////////////////////
void DummyRendering::Update(
    double _dt, const ecs::EntityQuery &_result, ecs::Manager &_mgr)
{
  // TODO make it easy to know the current sim time
  this->simTime += _dt;
  double framerate = 30.0;
  if (this->simTime < this->lastPubTime + 1.0 / framerate)
  {
    // Too early to publish
    return;
  }
  this->lastPubTime = this->simTime;
