...
namespace gazebo
{
  namespace ecs
  {
    ...
    class Manager
    {
      ...
      /// \brief Return a handle that grants acess to entities and components
      /// \remarks UpdateOnce() blocks until all handles are destructed
      public: std::unique_ptr<DataHandle> Handle();
